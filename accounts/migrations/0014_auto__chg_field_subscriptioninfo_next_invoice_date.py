...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_subscriptioninfo', 'next_invoice_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'SubscriptionInfo.next_invoice_date'
        db.alter_column('accounts_subscriptioninfo', 'next_invoice_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 1, 10, 0, 0)))
