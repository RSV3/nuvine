...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ContentTemplate', fields ['key']
        db.create_unique('cms_contenttemplate', ['key'])

        # Adding index on 'Section', fields ['key']
        db.create_index('cms_section', ['key'])


    def backwards(self, orm):
        # Removing index on 'Section', fields ['key']
        db.delete_index('cms_section', ['key'])

        # Removing unique constraint on 'ContentTemplate', fields ['key']
        db.delete_unique('cms_contenttemplate', ['key'])
