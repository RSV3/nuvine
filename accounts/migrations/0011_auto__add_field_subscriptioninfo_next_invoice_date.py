...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionInfo.next_invoice_date'
        db.add_column('accounts_subscriptioninfo', 'next_invoice_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 10, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionInfo.next_invoice_date'
        db.delete_column('accounts_subscriptioninfo', 'next_invoice_date')
    ...
    models = {
        ...
        'accounts.subscriptioninfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next_invoice_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
