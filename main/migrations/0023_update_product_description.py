...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        product = orm.Product.objects.get(cart_tag='tasting_kit', active=True)
        product.name = "Vinely's First Taste Kit"
        product.unit_price = 99
        product.description = """
        <p>Each Vinely First Taste Kit helps up to 12 people discover their true wine personality.
        The kit includes 6 bottles of wine and 12 Experience booklets.</p>

        <p>To ensure a complete blind wine tasting experience,
        the bottles have been pre-labeled 1-6. Don't peek, you'll spoil the fun!</p>"""
        product.save()
    ...
    def backwards(self, orm):
        ...
        old_content = """
        <p>The Vinely First Taste Kit helps Vinely Tasters discover their true wine personality.
        It includes six bottles of wine, each carefully selected for certain attributes to help Vinely understand your taste in wine.</p>

        <p>The kit also includes materials needed to conduct a Vinely tasting and record each taster’s preferences.</p>
        """

        product = orm.Product.objects.get(cart_tag='tasting_kit', active=True)
        product.description = old_content
        product.unit_price = 139
        product.save()
