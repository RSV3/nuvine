...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartyInvite.invited_timestamp'
        db.add_column('main_partyinvite', 'invited_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PartyInvite.response_timestamp'
        db.add_column('main_partyinvite', 'response_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartyInvite.invited_timestamp'
        db.delete_column('main_partyinvite', 'invited_timestamp')

        # Deleting field 'PartyInvite.response_timestamp'
        db.delete_column('main_partyinvite', 'response_timestamp')
