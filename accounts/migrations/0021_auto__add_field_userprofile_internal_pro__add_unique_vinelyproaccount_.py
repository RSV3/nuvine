...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.internal_pro'
        db.add_column('accounts_userprofile', 'internal_pro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'VinelyProAccount', fields ['account_number']
        db.create_unique('accounts_vinelyproaccount', ['account_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'VinelyProAccount', fields ['account_number']
        db.delete_unique('accounts_vinelyproaccount', ['account_number'])

        # Deleting field 'UserProfile.internal_pro'
        db.delete_column('accounts_userprofile', 'internal_pro')
