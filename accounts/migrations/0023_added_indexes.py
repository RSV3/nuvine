...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserProfile', fields ['vinely_customer_id']
        db.create_index('accounts_userprofile', ['vinely_customer_id'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['vinely_customer_id']
        db.delete_index('accounts_userprofile', ['vinely_customer_id'])
