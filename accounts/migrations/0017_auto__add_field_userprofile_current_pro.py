...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_pro'
        db.add_column('accounts_userprofile', 'current_pro',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assigned_profiles', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_pro'
        db.delete_column('accounts_userprofile', 'current_pro_id')
