...
class GeneralTaste(models.Model):
  ...
  coffee_type = models.IntegerField(choices=COFFEE_CHOICES, default=0, verbose_name='What type of [coffee/tea] do you prefer?')
  ...
  coffee_take = models.IntegerField(choices=COFFEE_TAKE_CHOICES, default=0, verbose_name='How do you typically take your [coffee/tea]?')
  ...
  salty_food = models.IntegerField(choices=SALTY_FOOD_CHOICES, default=0, verbose_name='Do you enjoy salty food/snacks?')

  # question 5
  CITRUS_CHOICES = (
      (1, 'I love lemons and limes on their own'),
      (2, 'I\'d prefer it with a touch of sweetness, like grapefruit juice'),
      (3, 'On the sweeter side.  Like orange juice.'),
      (4, 'As a soda flavor'),
      (5, 'I do not enjoy citrus whatsoever'),
  )
  citrus = models.IntegerField(choices=CITRUS_CHOICES, default=0, verbose_name='How do you prefer your citrus?')
  ...
  BERRIES_CHOICES = (
      ...
      (3, 'They\'re great.  But I\'d rather them be in a jelly or jam.'),
      (4, 'They\'re O.K.'),
      (5, 'Berries? Ick')
  )
  ...
  ARTIFICIAL_CHOICES = (
      ...
      (2, 'On occasion'),
      (3, 'I use them only if my food or drink really needs it'),
      (4, 'Rarely'),
      (5, 'No way')
  )
  artificial = models.IntegerField(choices=ARTIFICIAL_CHOICES, default=0, verbose_name='Do you use artificial sweeteners or consume products with them in it (i.e. Diet Soda)?')
...
class WineTaste(models.Model):
  ...
  red_body = models.IntegerField(choices=RED_BODY_CHOICES, default=0, verbose_name='Body:')
  ...
  red_sweetness = models.IntegerField(choices=RED_SWEETNESS_CHOICES, default=0, verbose_name='Sweetness:')
  ...
  red_acidity = models.IntegerField(choices=RED_ACIDITY_CHOICES, default=0, verbose_name='Acidity:')
  ...
  red_color = models.IntegerField(choices=RED_COLOR_CHOICES, default=0, verbose_name='Color:')
  ...
  red_wines_other = models.CharField(max_length=32, null=True, blank=True, verbose_name="Specify other wine:")
  ...
  red_wine_dislike_other = models.CharField(max_length=32, null=True, blank=True, verbose_name="Specify other wine:")
  ...
  white_oak = models.IntegerField(choices=WHITE_OAK_CHOICES, default=0, verbose_name='Oak:')
  ...
  white_sweetness = models.IntegerField(choices=WHITE_SWEETNESS_CHOICES, default=0, verbose_name='Sweetness:')
  ...
  white_acidity = models.IntegerField(choices=WHITE_ACIDITY_CHOICES, default=0, verbose_name='White:')
  ...
  white_color = models.IntegerField(choices=WHITE_COLOR_CHOICES, default=0, verbose_name='Color:')
