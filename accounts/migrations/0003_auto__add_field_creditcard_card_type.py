...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditCard.card_type'
        db.add_column('accounts_creditcard', 'card_type',
                      self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditCard.card_type'
        db.delete_column('accounts_creditcard', 'card_type')
