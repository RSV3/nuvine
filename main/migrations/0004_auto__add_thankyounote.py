...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThankYouNote'
        db.create_table('main_thankyounote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Party'])),
            ('custom_subject', self.gf('django.db.models.fields.CharField')(default='Thank you for attending our Vinely Taste Party', max_length=128)),
            ('custom_message', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('main', ['ThankYouNote'])

        # Adding M2M table for field guests on 'ThankYouNote'
        db.create_table('main_thankyounote_guests', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('thankyounote', models.ForeignKey(orm['main.thankyounote'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('main_thankyounote_guests', ['thankyounote_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'ThankYouNote'
        db.delete_table('main_thankyounote')

        # Removing M2M table for field guests on 'ThankYouNote'
        db.delete_table('main_thankyounote_guests')
    ...
    models = {
        ...
        'main.thankyounote': {
            ...
            'custom_message': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'custom_subject': ('django.db.models.fields.CharField', [], {'default': "'Thank you for attending our Vinely Taste Party'", 'max_length': '128'}),
            'guests': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Party']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
