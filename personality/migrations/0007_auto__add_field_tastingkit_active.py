...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TastingKit.active'
        db.add_column('personality_tastingkit', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TastingKit.active'
        db.delete_column('personality_tastingkit', 'active')
