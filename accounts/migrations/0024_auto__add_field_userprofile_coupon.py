...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.coupon'
        db.add_column('accounts_userprofile', 'coupon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon', null=True, to=orm['coupon.Coupon']),
                      keep_default=False)

        # Adding M2M table for field coupons on 'UserProfile'
        db.create_table('accounts_userprofile_coupons', (
        ...
        db.create_unique('accounts_userprofile_coupons', ['userprofile_id', 'coupon_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.coupon'
        db.delete_column('accounts_userprofile', 'coupon_id')

        # Removing M2M table for field coupons on 'UserProfile'
        db.delete_table('accounts_userprofile_coupons')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'account_credit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            ...
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coupon'", 'null': 'True', 'to': "orm['coupon.Coupon']"}),
            'coupons': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'coupons'", 'null': 'True', 'to': "orm['coupon.Coupon']"}),
            ...
            'internal_pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'vinely_customer_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        'accounts.vinelyproaccount': {
            ...
            'account_number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '8'}),
