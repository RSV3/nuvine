...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        pre_newparty_date = datetime.datetime(2013, 03, 13)
        orm.Party.objects.filter(created__lt=pre_newparty_date).update(confirmed=True, requested=True)

    def backwards(self, orm):
        "Write your backwards methods here."
        pre_newparty_date = datetime.datetime(2013, 03, 13)
        orm.Party.objects.filter(created__lt=pre_newparty_date).update(confirmed=False, requested=False)
