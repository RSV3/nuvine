...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wine.added'
        db.delete_column('personality_wine', 'added')


    def backwards(self, orm):
        # Adding field 'Wine.added'
        db.add_column('personality_wine', 'added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 1, 31, 0, 0), blank=True),
                      keep_default=False)
