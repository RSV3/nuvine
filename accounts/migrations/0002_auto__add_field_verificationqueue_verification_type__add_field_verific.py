...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerificationQueue.verification_type'
        db.add_column('accounts_verificationqueue', 'verification_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VerificationQueue.verify_data'
        db.add_column('accounts_verificationqueue', 'verify_data',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerificationQueue.verification_type'
        db.delete_column('accounts_verificationqueue', 'verification_type')

        # Deleting field 'VerificationQueue.verify_data'
        db.delete_column('accounts_verificationqueue', 'verify_data')
