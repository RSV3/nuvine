...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditCard.card_type'
        db.alter_column('accounts_creditcard', 'card_type', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'CreditCard.card_type'
        db.alter_column('accounts_creditcard', 'card_type', self.gf('django.db.models.fields.CharField')(max_length=10))
