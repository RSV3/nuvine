...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SelectedWine.wine'
        db.alter_column('main_selectedwine', 'wine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personality.Wine']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SelectedWine.wine'
        db.alter_column('main_selectedwine', 'wine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['support.Wine']))

        # Changing field 'Party.address'
        db.alter_column('main_party', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 2, 8, 0, 0), to=orm['accounts.Address']))
