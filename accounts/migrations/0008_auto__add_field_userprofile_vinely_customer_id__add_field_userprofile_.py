...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.vinely_customer_id'
        db.add_column('accounts_userprofile', 'vinely_customer_id',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.work_phone'
        db.add_column('accounts_userprofile', 'work_phone',
                      self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.vinely_customer_id'
        db.delete_column('accounts_userprofile', 'vinely_customer_id')

        # Deleting field 'UserProfile.work_phone'
        db.delete_column('accounts_userprofile', 'work_phone')
