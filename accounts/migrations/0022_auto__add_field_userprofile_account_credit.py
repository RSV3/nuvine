...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.account_credit'
        db.add_column('accounts_userprofile', 'account_credit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.account_credit'
        db.delete_column('accounts_userprofile', 'account_credit')
