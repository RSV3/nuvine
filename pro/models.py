...
class MonthlyQualification(models.Model):
  ...
  pro = models.ForeignKey(User)
  total_personal_sales = models.DecimalField(max_digits=15, decimal_places=2)
  total_sales_1st_line = models.DecimalField(max_digits=15, decimal_places=2)
...
class MonthlyBonusCompensation(models.Model):
  ...
  tier_a_personal_sales = models.DecimalField(max_digits=15, decimal_places=2)
  tier_b_personal_sales = models.DecimalField(max_digits=15, decimal_places=2)
  total_first_downline_sales = models.DecimalField(max_digits=15, decimal_places=2)
  total_second_downline_sales = models.DecimalField(max_digits=15, decimal_places=2)
  total_third_downline_sales = models.DecimalField(max_digits=15, decimal_places=2)
  tier_a_bonus = models.DecimalField(max_digits=14, decimal_places=2)
  tier_b_bonus = models.DecimalField(max_digits=14, decimal_places=2)
  first_line_bonus = models.DecimalField(max_digits=14, decimal_places=2)
  second_line_bonus = models.DecimalField(max_digits=14, decimal_places=2)
  third_line_bonus = models.DecimalField(max_digits=14, decimal_places=2)
  start_time = models.DateTimeField()
  end_time = models.DateTimeField()
