...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('personality_winepersonality', (
            ...
            ('headline', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('suffix', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ...
        db.create_table('personality_generaltaste', (
            ...
            ('coffee_type', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('coffee_take', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('salty_food', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ...
        db.create_table('personality_winetaste', (
            ...
            ('red_body', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('red_sweetness', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('red_acidity', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('red_color', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ...
            ('white_oak', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('white_sweetness', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('white_acidity', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('white_color', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
