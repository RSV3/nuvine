...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProSignupLog'
        db.create_table('main_prosignuplog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('new_pro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('mentor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='new_mentees', null=True, to=orm['auth.User'])),
            ('mentor_email', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('main', ['ProSignupLog'])

        # Adding field 'MyHost.email_entered'
        db.add_column('main_myhost', 'email_entered',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProSignupLog'
        db.delete_table('main_prosignuplog')

        # Deleting field 'MyHost.email_entered'
        db.delete_column('main_myhost', 'email_entered')
