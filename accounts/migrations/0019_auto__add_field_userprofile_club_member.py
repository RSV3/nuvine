...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.club_member'
        db.add_column('accounts_userprofile', 'club_member',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.club_member'
        db.delete_column('accounts_userprofile', 'club_member')
