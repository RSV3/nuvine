...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_personalog', (
            ...
            ('specialist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personality_acquired', null=True, to=orm['auth.User'])),
        ...
        db.create_table('main_organizedparty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('specialist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Party'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('main', ['OrganizedParty'])

        # Adding field 'Cart.party'
        db.add_column('main_cart', 'party',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Party'], null=True),
                      keep_default=False)

        # Adding field 'Cart.status'
        db.add_column('main_cart', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Cart.adds'
        db.add_column('main_cart', 'adds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Cart.removes'
        db.add_column('main_cart', 'removes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Cart.views'
        db.add_column('main_cart', 'views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cart.party'
        db.delete_column('main_cart', 'party_id')

        # Deleting field 'Cart.status'
        db.delete_column('main_cart', 'status')

        # Deleting field 'Cart.adds'
        db.delete_column('main_cart', 'adds')

        # Deleting field 'Cart.removes'
        db.delete_column('main_cart', 'removes')

        # Deleting field 'Cart.views'
        db.delete_column('main_cart', 'views')
    ...
    models = {
        ...
        'main.organizedparty': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Party']"}),
            'specialist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        'main.party': {
        ...
        'main.personalog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Party']", 'null': 'True'}),
            'specialist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'personality_acquired'", 'null': 'True', 'to': "orm['auth.User']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
