...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewHostNoParty'
        db.create_table('main_newhostnoparty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('main', ['NewHostNoParty'])

        # Adding model 'UnconfirmedParty'
        db.create_table('main_unconfirmedparty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Party'])),
        ))
        db.send_create_signal('main', ['UnconfirmedParty'])

        # Adding model 'SelectedWine'
        ...
        db.send_create_signal('main', ['SelectedWine'])

        # Adding field 'Cart.discount'
        db.add_column('main_cart', 'discount',
        ...
        # Changing field 'CustomizeOrder.timestamp'
        db.alter_column('main_customizeorder', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'OrganizedParty.pro'
        db.alter_column('main_organizedparty', 'pro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        ...
        # Adding field 'InvitationSent.signature'
        db.add_column('main_invitationsent', 'signature',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


        # Changing field 'InvitationSent.custom_message'
        db.alter_column('main_invitationsent', 'custom_message', self.gf('django.db.models.fields.TextField')(null=True))
        ...
        # Adding field 'Party.confirmed'
        db.add_column('main_party', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Party.requested'
        db.add_column('main_party', 'requested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Party.setup_stage'
        db.add_column('main_party', 'setup_stage',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Party.address'
        db.alter_column('main_party', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Address'], null=True))

    def backwards(self, orm):
        # Deleting model 'NewHostNoParty'
        db.delete_table('main_newhostnoparty')

        # Deleting model 'UnconfirmedParty'
        db.delete_table('main_unconfirmedparty')

        # Deleting model 'SelectedWine'
        db.delete_table('main_selectedwine')

        # Deleting field 'Cart.discount'
        db.delete_column('main_cart', 'discount')


        # Changing field 'PartyInvite.invited_timestamp'
        db.alter_column('main_partyinvite', 'invited_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 26, 0, 0)))

        # Changing field 'CustomizeOrder.timestamp'
        db.alter_column('main_customizeorder', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'OrganizedParty.pro'
        db.alter_column('main_organizedparty', 'pro_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
        ...
        # Deleting field 'InvitationSent.signature'
        db.delete_column('main_invitationsent', 'signature')


        # Changing field 'InvitationSent.custom_message'
        db.alter_column('main_invitationsent', 'custom_message', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
        ...
        # Deleting field 'Party.confirmed'
        db.delete_column('main_party', 'confirmed')

        # Deleting field 'Party.requested'
        db.delete_column('main_party', 'requested')

        # Deleting field 'Party.setup_stage'
        db.delete_column('main_party', 'setup_stage')


        # Changing field 'Party.address'
        db.alter_column('main_party', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Address']))
