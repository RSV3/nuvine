...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StripeCard.billing_zipcode'
        db.add_column('stripecard_stripecard', 'billing_zipcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StripeCard.billing_zipcode'
        db.delete_column('stripecard_stripecard', 'billing_zipcode')
