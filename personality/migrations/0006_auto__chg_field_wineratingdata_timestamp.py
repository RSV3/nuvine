...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WineRatingData.timestamp'
        db.alter_column('personality_wineratingdata', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'WineRatingData.timestamp'
        db.alter_column('personality_wineratingdata', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
