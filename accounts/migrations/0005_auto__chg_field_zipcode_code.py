...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Zipcode.code'
        db.alter_column('accounts_zipcode', 'code', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'Zipcode.code'
        db.alter_column('accounts_zipcode', 'code', self.gf('django.db.models.fields.IntegerField')())
