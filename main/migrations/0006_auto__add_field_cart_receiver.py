...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.receiver'
        db.add_column('main_cart', 'receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.receiver'
        db.delete_column('main_cart', 'receiver_id')
