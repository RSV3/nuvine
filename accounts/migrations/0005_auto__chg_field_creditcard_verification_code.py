...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditCard.verification_code'
        db.alter_column('accounts_creditcard', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'CreditCard.verification_code'
        db.alter_column('accounts_creditcard', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=4))
