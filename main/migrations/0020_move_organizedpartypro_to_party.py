...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        pro_parties = orm.OrganizedParty.objects.all()
        for p in pro_parties:
            p.party.pro = p.pro
            p.party.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        pro = orm['auth.User'].objects.get(pk=1)
        orm.Party.objects.all().update(pro=pro)
    ...
    models = {
        ...
        'main.party': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'pro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pro'", 'to': "orm['auth.User']"}),
