...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionInfo.updated_datetime'
        db.add_column('accounts_subscriptioninfo', 'updated_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionInfo.updated_datetime'
        db.delete_column('accounts_subscriptioninfo', 'updated_datetime')
