...
urlpatterns = patterns('main.views',
    ...
    url(r'^howitworks/(?P<state>\w+)/$', 'how_it_works', name='how_it_works'),
    url(r'^howitworks/$', 'how_it_works', name='how_it_works'),
    ...
    url(r'^party/edit/(?P<party_id>\d+)/$', 'party_edit_date', name='party_edit_date'),
    ...
    url(r'^party/preview/thanks/(?P<party_id>\d+)/$', 'party_preview_thanks_note', name='party_preview_thanks_note'),
    url(r'^party/preview/host/confirmation/(?P<party_id>\d+)/(?P<email_id>\d+)/$', 'party_host_confirmation_preview', name='party_host_confirmation_preview'),
