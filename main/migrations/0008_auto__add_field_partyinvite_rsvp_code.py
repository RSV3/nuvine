...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartyInvite.rsvp_code'
        db.add_column('main_partyinvite', 'rsvp_code',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartyInvite.rsvp_code'
        db.delete_column('main_partyinvite', 'rsvp_code')
