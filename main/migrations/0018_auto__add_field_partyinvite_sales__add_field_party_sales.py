...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartyInvite.sales'
        db.add_column('main_partyinvite', 'sales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Party.sales'
        db.add_column('main_party', 'sales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartyInvite.sales'
        db.delete_column('main_partyinvite', 'sales')

        # Deleting field 'Party.sales'
        db.delete_column('main_party', 'sales')
