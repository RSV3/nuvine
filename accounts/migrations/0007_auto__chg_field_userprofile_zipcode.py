...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_userprofile', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.zipcode'
        db.alter_column('accounts_userprofile', 'zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
