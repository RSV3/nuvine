...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.alter_column('accounts_subscriptioninfo', 'next_invoice_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'last_page': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
