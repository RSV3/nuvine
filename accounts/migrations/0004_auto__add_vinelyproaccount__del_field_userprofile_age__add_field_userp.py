...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'age')

        # Adding field 'UserProfile.image'
        db.add_column('accounts_userprofile', 'image',
        ...
        db.add_column('accounts_userprofile', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='00000', max_length=20),
                      keep_default=False)
