...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.refund_amount'
        db.add_column('main_order', 'refund_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.refund_date'
        db.add_column('main_order', 'refund_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.refund_amount'
        db.delete_column('main_order', 'refund_amount')

        # Deleting field 'Order.refund_date'
        db.delete_column('main_order', 'refund_date')
    ...
    models = {
        ...
        'main.order': {
            ...
            'refund_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'refund_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
