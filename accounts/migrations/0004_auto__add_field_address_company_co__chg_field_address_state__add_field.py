...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.company_co'
        db.add_column('accounts_address', 'company_co',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Address.state'
        db.alter_column('accounts_address', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2))
        # Adding field 'UserProfile.news_optin'
        db.add_column('accounts_userprofile', 'news_optin',
        ...
        db.alter_column('accounts_userprofile', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

    def backwards(self, orm):
        # Deleting field 'Address.company_co'
        db.delete_column('accounts_address', 'company_co')


        # Changing field 'Address.state'
        db.alter_column('accounts_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'UserProfile.news_optin'
        db.delete_column('accounts_userprofile', 'news_optin')
        ...
        # Changing field 'UserProfile.phone'
        db.alter_column('accounts_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
