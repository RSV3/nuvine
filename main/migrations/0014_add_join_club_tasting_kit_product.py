...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        p, created = orm.Product.objects.get_or_create(name="Join the Club Tasting Kit", description="", unit_price=97.00, category=0, cart_tag="join_club_tasting_kit")

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Product.objects.get(cart_tag="join_club_tasting_kit").delete()
