...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.full_case_price'
        db.add_column('main_product', 'full_case_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.full_case_price'
        db.delete_column('main_product', 'full_case_price')
