...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VinelyProAccount.account_number'
        db.alter_column('accounts_vinelyproaccount', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=8))

    def backwards(self, orm):

        # Changing field 'VinelyProAccount.account_number'
        db.alter_column('accounts_vinelyproaccount', 'account_number', self.gf('django.db.models.fields.BigIntegerField')())
