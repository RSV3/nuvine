...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.stripe_card'
        db.add_column('main_order', 'stripe_card',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stripecard.StripeCard'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.stripe_card'
        db.delete_column('main_order', 'stripe_card_id')
