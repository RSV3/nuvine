...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Product.objects.filter(cart_tag='tasting_kit', active=True).update(unit_price=139.99)

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Product.objects.filter(cart_tag='tasting_kit', active=True).update(unit_price=99)
