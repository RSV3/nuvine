...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.stripe_card'
        db.add_column('accounts_userprofile', 'stripe_card',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='stripe_owner', null=True, to=orm['stripecard.StripeCard']),
                      keep_default=False)

        # Adding M2M table for field stripe_cards on 'UserProfile'
        db.create_table('accounts_userprofile_stripe_cards', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('stripecard', models.ForeignKey(orm['stripecard.stripecard'], null=False))
        ))
        db.create_unique('accounts_userprofile_stripe_cards', ['userprofile_id', 'stripecard_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.stripe_card'
        db.delete_column('accounts_userprofile', 'stripe_card_id')

        # Removing M2M table for field stripe_cards on 'UserProfile'
        db.delete_table('accounts_userprofile_stripe_cards')
    ...
    models = {
        ...
        'stripecard.stripecard': {
            ...
            'stripe_user': ('django.db.models.fields.CharField', [], {'max_length': '16'})
        }
    }
