...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentTemplate.name'
        db.add_column('cms_contenttemplate', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'ContentTemplate.active'
        db.add_column('cms_contenttemplate', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentTemplate.name'
        db.delete_column('cms_contenttemplate', 'name')

        # Deleting field 'ContentTemplate.active'
        db.delete_column('cms_contenttemplate', 'active')
