...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TastingKit'
        db.create_table('personality_tastingkit', (
        ...
        db.send_create_signal('personality', ['TastingKit'])

        # Deleting field 'Wine.vintage'
        db.delete_column('personality_wine', 'vintage')

        # Adding field 'Wine.brand'
        db.add_column('personality_wine', 'brand',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Wine.enclosure'
        db.add_column('personality_wine', 'enclosure',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TastingKit'
        db.delete_table('personality_tastingkit')
        ...
        # Deleting field 'Wine.brand'
        db.delete_column('personality_wine', 'brand')

        # Deleting field 'Wine.enclosure'
        db.delete_column('personality_wine', 'enclosure')
