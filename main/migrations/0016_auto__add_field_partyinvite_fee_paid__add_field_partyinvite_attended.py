...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartyInvite.fee_paid'
        db.add_column('main_partyinvite', 'fee_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartyInvite.attended'
        db.add_column('main_partyinvite', 'attended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartyInvite.fee_paid'
        db.delete_column('main_partyinvite', 'fee_paid')

        # Deleting field 'PartyInvite.attended'
        db.delete_column('main_partyinvite', 'attended')
