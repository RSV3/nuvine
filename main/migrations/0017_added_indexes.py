...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Product', fields ['category']
        db.create_index('main_product', ['category'])

        # Adding index on 'LineItem', fields ['frequency']
        db.create_index('main_lineitem', ['frequency'])

        # Adding index on 'Party', fields ['event_date']
        db.create_index('main_party', ['event_date'])


    def backwards(self, orm):
        # Removing index on 'Party', fields ['event_date']
        db.delete_index('main_party', ['event_date'])

        # Removing index on 'LineItem', fields ['frequency']
        db.delete_index('main_lineitem', ['frequency'])

        # Removing index on 'Product', fields ['category']
        db.delete_index('main_product', ['category'])
